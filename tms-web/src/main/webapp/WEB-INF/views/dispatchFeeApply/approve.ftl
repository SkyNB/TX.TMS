...
<div id="dispatchFeeApplyApprove" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="dispatchFeeApplyApproveForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-plus"></i>&nbsp;费用审批</h4>
                </div>
                    ...
                    <div class="tabbable-line">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="dispatchFeeApply">
                                ...
                                <div class="row">
                                    <div kendo-grid k-data-source="feeApplyItemDataSource" k-editable="true"
