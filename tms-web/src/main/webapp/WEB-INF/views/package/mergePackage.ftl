...
<div id="mergePackage" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="mergePackageForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-plus"></i>&nbsp;打包</h4>
                </div>
                ...
                <#--打包明细-->
                    <div id="packageItemGrid" kendo-grid k-data-source="itemDataSource" k-editable="true"
                         k-toolbar="toolbar" k-columns="itemColumns"></div>
                </div>
...
<script>
    var packageSizes = ${jsonMapper.writeValueAsString(packageSizes)};
    var wrapMaterials = ${jsonMapper.writeValueAsString(wrapMaterials)};
    /*$.each(packageSizes,function(i,item){
