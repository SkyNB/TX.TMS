angular.module('RoadnetApp').controller('ConsignOrderUpdateController', ['$rootScope', '$scope', '$state', '$stateParams', ConsignOrderUpdateController]);
function ConsignOrderUpdateController($rootScope, $scope, $state, $stateParams) {
    ...
    $("#consignOrderUpdate").on("shown.bs.modal",function(){
        $scope.init();
    });
    ...
    $("#consignOrderUpdate").on("hidden.bs.modal", function () {
        $(".modal-backdrop.fade.in").remove();
    });

    $scope.validate = $("#consignOrderUpdateForm").validate();
    ...
    $scope.submit = function () {
        ...
        $.ajax({
            url: contextPath + "/consign/update",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify($scope.consign)
        }).done(function (result) {
            if (result.success) {
                $("#consignOrderUpdate").modal("hide");
                toastr.success("修改成功!");
